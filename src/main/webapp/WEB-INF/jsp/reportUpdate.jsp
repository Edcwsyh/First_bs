...
<nav class="navbar navbar-default">
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li  class="active"><a href="${pageContext.request.contextPath}/report/user_report_list"><span class="glyphicon glyphicon-tags"></span>&nbsp;&nbsp;我的周报</a></li>
   ...
   <div style="margin-left: 400px;margin-right: 200px" class="col-md-5">
            <div class="modal-body">
                <form action="${pageContext.request.contextPath}/report/report_update" method="post">
                	<input type="hidden" name="id" value="${result.data.id}"/>
                    <div class="form-group">
                   		
	                    <label for="content">周报内容</label>
	                    <textarea id="content" name="content" class="form-control" rows="15" cols="10" >${result.data.content }</textarea>
                	</div>
                	
                	<div class="form-group">
                        <label for="week">周报所属周次</label>
                        <select id="week" name="week" class="form-control">                      	  
                        	<option selected="selected">${result.data.week}</option>
                        	<option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                    ...
                    <div class="form-group">
                        ...
                        <div>
	                        <input type="radio" name="isSubmit" value=true ${result.data.isSubmit == true ? 'checked':''}> 是
	                        <input type="radio" name="isSubmit" value=false ${result.data.isSubmit == false ? 'checked':''}> 否
                        </div>
