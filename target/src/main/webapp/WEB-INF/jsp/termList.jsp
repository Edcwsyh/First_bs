...
<nav class="navbar navbar-default">
	...
	<div class="col-md-2">
	    <div class="list-group">
	        ...
	        <a href="" role="button"  class="list-group-item" data-toggle="modal" data-target="#myModal">创建新学期</a>
	    </div>
	</div>
	<div class="col-md-10">
	...
	<ul class="nav nav-tabs">
	    ...
	    <li>
	        <a href="${pageContext.request.contextPath}/term/goto_term_create">创建新学期</a>
	    </li>
	</ul>
	<table class="table">
	    <thead>
